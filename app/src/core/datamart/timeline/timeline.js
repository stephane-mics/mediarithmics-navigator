define(['./module'], function (module) {
    ...
    module.controller('core/datamart/timeline/timeline', [
        ...
        function($scope, $stateParams, Restangular, Common, $, Session, lodash, moment) {
            ...
            $scope.isTimeLineReady = function(){
               ...
               return typeof $scope.timeline !== "undefined";
            };

            //TODO communicate with the service which is responsible of loading time line
            //for the moment we load all the timeline
            //we need to implement the function to load only a part of the timeline
            //and when we click on load more , we load the rest of the timeline
